...
HALF-LIFE
##########
# Coefficients for exponential fits for mean decay of non-coupled noisy oscillators
popt1 = [0.362215, 0.00099855, 0.637115] # R2 = 0.9982
popt2 = [1.27066, 0.000797632, -0.282885] # R2 = 0.9983
popt3 = [1.04445, 0.0052881, -0.032042] # R2 = 0.9984
popt4 = [1.00651, 0.0325793, 0.00844607] # R2 = 0.9837
...
halflife = [20.961, 127.555, 607.18] # For E=0.05 it was too hard to find
E = [0.5, 0.2, 0.1] # Noise strength
plt.plot(E, halflife, 'o-')
plt.xlabel('E (noise strength)')
plt.ylabel('t1/2 to decay')
plt.title('Half-life of mean of noisy system')
plt.grid()

#############
Need more data to make the half-life curve
##########
n=1000
t6 = np.linspace(0,600,600*20)
state06 = [1,0]*n
